      ...
      <SectionWrapper>
            ...
            <Flex justifyContent="space-between" style={{ flexFlow: 'row wrap' }}>
              ...
              <Flex flexWrap="wrap">
                <Flex mr="10px" mb="10px">
                  <Box background="#FF7D04" height="7px" width="30px" marginTop="7px" marginRight=" 5px">
                    {' '}
                  </Box>
                  <Text>{t('USD Value')}</Text>
                </Flex>
                <Flex mr="10px" mb="10px">
                  <Box background="#7B3FE4" height="7px" width="30px" marginTop="7px" marginRight=" 5px">
                    {' '}
                  </Box>
        ...
        <Flex className="infoSide" flex="1">
          <Section isDark={isDark}>
            ...
            <Text fontSize="12px" color="#6F767E" mt="10px">
            ...
            <Flex alignItems="center" justifyContent="space-between">
              ...
              {farmData ? (
                <Text fontWeight="bold">
                  {new BigNumber(farmData[8]).toFixed(3, 1)} {tokenName} + {new BigNumber(farmData[9]).toFixed(3, 1)}{' '}
                  {quoteTokenName}
                </Text>
              ) : (
